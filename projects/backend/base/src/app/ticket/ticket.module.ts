...
@Module({
    imports: [
        TypeOrmModule.forFeature([
            TicketEntity, TicketCommentEntity, TicketCategoryEntity, TicketProjectEntity,
            TicketLabelEntity, TicketLinkEntity, TicketActivityLogEntity,
            TicketWorkflowEntity, TicketWorkflowStatusEntity, TicketWorkflowTransitionEntity,
            TicketSprintEntity, TicketSlaConfigEntity,
            TicketWatcherEntity, TicketAttachmentEntity, TicketWorkLogEntity,
            TicketProjectMemberEntity, TicketAutomationRuleEntity, TicketCustomFieldDefEntity,
            UserEntity
        ])
    ],
    controllers: [
        TicketController, TicketAdminController, TicketBoardController,
        TicketSprintController, TicketReportingController, TicketRoadmapController
    ],
    providers: [
        TicketService, TicketAdminService, TicketActivityService, TicketWorkflowService,
        TicketSprintService, TicketReportingService, TicketSlaService,
        TicketWatcherService, TicketAttachmentService, TicketWorkLogService,
        TicketProjectMemberService, TicketAutomationService, TicketCustomFieldService, TicketRoadmapService
    ],
